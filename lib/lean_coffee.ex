defmodule LeanCoffee do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: LeanCoffee.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    LeanCoffee.Endpoint.config_change(changed, removed)
    :ok
  end
end
